	...
	switch(state){
		case 0:
			...
			if(ch=='0')state=19;
				...
				case '+':state=11;break;
				case '-':state=12;break;
				case '*':state=0;out<<"(33,-)";s.insert(33);sum++;break;
				case '/':state=13;break;
				case '(':state=0;out<<"(24,-)";s.insert(24);sum++;break;
				case ')':state=0;out<<"(25,-)";s.insert(25);sum++;break;
				case '!':state=16;break;
				case '[':state=0;out<<"(26,-)";s.insert(26);sum++;break;
				case ']':state=0;out<<"(27,-)";s.insert(27);sum++;break;
				case '{':state=0;out<<"(36,-)";s.insert(36);sum++;break;
				case '}':state=0;out<<"(37,-)";s.insert(37);sum++;break;
				case '.':state=22;break;
				case '"':state=17;break;
				case '\'':state=23;break;
				case '#':state=0;out<<"(39,-)";s.insert(39);sum++;break;
				case ';':state=0;out<<"(32,-)";s.insert(32);sum++;break; 
				case ',':state=0;out<<"(52,-)";s.insert(52);sum++;break; 
			}
			break;
		case 1://标识符 or 关键字 
			nowstring+=ch;
...
void lexical_analyzer::printkey(int key){
	out<<"("<<key<<","<<"-"<<")";
	//cout<<"("<<key<<","<<"-"<<")";
}
void lexical_analyzer::printidentifier(int no){
	out<<"("<<21<<","<<no<<")";
	//cout<<"("<<21<<","<<no<<")";
}
void lexical_analyzer::printconst(int no){
	out<<"("<<46<<","<<no<<")";
	//cout<<"("<<46<<","<<no<<")";
}
void lexical_analyzer::printother(int no){
	out<<"("<<no<<","<<"-"<<")";
	//cout<<"("<<no<<","<<"-"<<")";
}
